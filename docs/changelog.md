...
- Fixed performance issue if the object has a lot of merge tags
...
- Fix issue when unable to get contacts on company page
...
- Fix issue when unable to get recipient if you on person page
- Fix field name from phone to mobile for recipients
- Added automatically updating configuration after update package
